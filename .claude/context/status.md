...
- 2026-01-08: Moin.ButtonToken 扩展完整 antd ComponentToken（支持浅暗色主题）
...
- 2026-01-08: 删除无用 UI 测试（Moin.ButtonTests、Moin.ButtonGroupTests）
- 2026-01-08: 移除 type 参数，统一用 color + variant（对齐 antd 5.21+）
- 2026-01-08: Moin.ButtonColor 支持 .custom(Color) 自定义颜色
...
- 2026-01-07: 实现 Moin.ButtonLoading（delay、自定义 icon）
