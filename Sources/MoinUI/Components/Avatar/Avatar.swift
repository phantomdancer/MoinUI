...
public extension Moin {
    ...
    struct Avatar: View {
        ...
        public init(
            ...
            self.init(
                content: AnyView(AsyncImage(url: src, fallbackIcon: fallbackIcon)),
                size: size,
                shape: shape,
                icon: nil,
                text: nil,
        ...
        public init(
            ...
            self.init(
                content: AnyView(AsyncImage(url: URL(string: src), fallbackIcon: fallbackIcon)),
                size: size,
                shape: shape,
                icon: nil,
                text: nil,
