...
// MARK: - _Progress (internal name, use Moin.Progress.View)

public struct _Progress: View {
    public enum Variant {
        case line
        case circle
        case dashboard
        ...
        GeometryReader { geo in
            ...
            ZStack(alignment: .leading) {
                ...
                if currentStatus == .active {
                    _ProgressActiveAnimationView(width: w, height: effectiveStrokeWidth, radius: radius)
                }
            }
        }
        .frame(height: effectiveStrokeWidth)
...
// MARK: - Internal Views
extension _Progress {
    struct _ProgressActiveAnimationView: View {
        let width: CGFloat
        let height: CGFloat
        let radius: CGFloat
