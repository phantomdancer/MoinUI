...
// MARK: - _Empty (internal name, use Moin.Empty.View)

/// 空状态组件
public struct _Empty<Content: View>: View {
...
public extension _Empty where Content == EmptyView {
    init(
