...
public struct MoinUIToken {
    ...
    public static let light = MoinUIToken(
        colorPrimary: Constants.Colors.primary,
        colorPrimaryHover: Constants.Colors.primaryHover,
        colorPrimaryActive: Constants.Colors.primaryActive,
        colorSuccess: Constants.Colors.success,
        colorWarning: Constants.Colors.warning,
        colorDanger: Constants.Colors.danger,
        colorInfo: Constants.Colors.info,
        colorBgContainer: Constants.Colors.background,
        colorBgElevated: Color.white,
        colorBgHover: Constants.Colors.backgroundHover,
        colorText: Constants.Colors.textPrimary,
        colorTextSecondary: Constants.Colors.textSecondary,
        colorTextDisabled: Constants.Colors.textDisabled,
        colorBgDisabled: Constants.Colors.backgroundDisabled,
        colorBorder: Constants.Colors.border,
        colorBorderHover: Constants.Colors.borderHover,
        ...
        paddingLG: Constants.Spacing.lg,
        paddingSM: Constants.Spacing.sm,
        motionDuration: Constants.Duration.normal
    )
