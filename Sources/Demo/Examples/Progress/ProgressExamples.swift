...
private struct DashboardDemo: View {
    ...
    @State private var gapPosition: Moin.ProgressGapPosition = .bottom
            ...
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack {
                    ...
                    Picker("", selection: $gapPosition) {
                        Text("Top").tag(Moin.ProgressGapPosition.top)
                        Text("Bottom").tag(Moin.ProgressGapPosition.bottom)
                        Text("Left").tag(Moin.ProgressGapPosition.left)
                        Text("Right").tag(Moin.ProgressGapPosition.right)
                    }
                    .pickerStyle(.segmented)
                    .fixedSize()
                }
